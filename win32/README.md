 ...
 * arm-none-eabi-gcc desde lauchpad

TODO
----
 - Bajar desde la pagina de freddy chopins (mantenedor del paquete compilado para win32)
 - O bajar el codigo fuente y compilar a mano usando cygwin (recordar limpiar el entorno para posterior uso de NSIS)
 - Realizar un *.ini con los parametros de eclipse correspondientes
